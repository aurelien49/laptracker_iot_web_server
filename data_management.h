...
public:
  ...
  std::vector<CustomDataStruct>& getdataList();
...
private:
  void setdataList(const std::vector<CustomDataStruct>& values);

  void addTemperatureHumidity(CustomDataStruct data);
